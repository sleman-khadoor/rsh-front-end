<template>
    <div class="col-12 pt-4 pb-4">
        <div class="bg-primary rounded-4">
            <div class="font-x-large weight-meduim text-dark-blue text-center pt-5">Discover <span class="text-choco">Rashm's</span> diverse services</div>
                ...
                <div v-for="(department, i) in departments" :key="i" class="col-lg-4 col-md-4 col-sm-6 mb-4">
                    ...
                    <div class="card-body my-3">
                        <div class="d-flex justify-content-start mb-3">
                             ...
                             <span class="text-dark-blue font-large weight-meduim px-1 my-auto">{{department.title}}</span>
                        </div>
                        
                        <p class="card-text text-grey font-small weight-regular">
                            {{department.text}}
                        </p>
                    </div>
                    </div>
