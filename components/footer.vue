        ...
        <div class="row bg-dark-blue p-5 text-primary m-0">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <ul class="p-0">
                    ...
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Home</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">About Us</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Services</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Blogs</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Books</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Our Partners</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Publish With Us</li>
                    <li class="font-xx-small lh-25 ff-regular text-white-gray">Contact Us</li>
                </ul>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <ul class="p-0">
            ...
            <div class="col-lg-3 col-md-2 col-sm-12 justify-content-center">
                <ul class="p-0">
