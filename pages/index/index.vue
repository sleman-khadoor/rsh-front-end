...
const pageKeywords = computed(() => {
  return locale.value === 'ar'
    ? 'رشم, أخبار, خدمات, كتب, مدونات, كتب عربي, روايات مترجمة, دار نشر, دار رشم, دار رشم للنشر, رشم للنشر, دار نشر عربية, كتب عربية, ندوات, أدب, الكتاب السعوديون, الكتاب العرب, المؤلفين, رواية, توزيع الكتب, نشر الكتب, خدمات التحرير, خدمات الترجمة, تسويق الكتب, ترجمة الكتب, إعداد المخطوطات, حقوق المؤلفين, دار نشر سعودية'
