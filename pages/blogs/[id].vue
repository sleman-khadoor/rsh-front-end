    ...
    <div class="row bg-secondary m-0">
        ...
        <div class="col-12 mx-auto text-start rounded-4 py-5 px-lg-5 px-md-5 px-sm-4 text-dark-blue">
            ...
            <div class="d-flex flex-wrap mb-3">
                <span class="badge text-choco bg-dark-snow font-small weight-regular m-1">History</span>
                <span class="badge text-choco bg-dark-snow font-small weight-regular m-1">History</span>
                <span class="badge text-choco bg-dark-snow font-small weight-regular m-1">History</span>
                <span class="badge text-choco bg-dark-snow font-small weight-regular m-1">History</span>
                <span class="badge text-choco bg-dark-snow font-small weight-regular m-1">History</span>
            ...
            <div>
                <div class="d-flex justify-content-between mb-2">
                    <span class="font-large weight-meduim">Here we write the blog title</span>
                    <span class="font-small weight-regular">Monady At 08.08.2021</span>
                </div>
                <div class="mb-1">
                    <span class="font-meduim weight-regular text-choco">Author Name</span>
                </div>
                <div>
                    <p class="text-grey font-meduim weight-regular lh-22">
                        ...
                        sit amet..", comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those
                        interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form,
            ...
            <div>
                <span class="font-large weight-meduim">Similar Blogs</span>
